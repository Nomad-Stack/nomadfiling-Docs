...
<Steps>
  ...
  After a valid submission, Nomadfiling calls `generateForm7004()` and produces a PDF in the browser. The workflow then moves to the result screen where you can review the filing summary and download the file.
...
The generated file uses the `f7004-2025.pdf` template and is built in the browser. Your form data is used to populate the 2025 extension PDF before you download it or send it by fax.
